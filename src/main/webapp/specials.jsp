...
<div id="wrap">
    ...
    <div class="center_content">
        <div class="left_content">
            ...
            <div class="title"><span class="title_icon"><img src="images/bullet1.gif" alt="" title="" /></span>Special Offers</div>

            <%
                // Récupérer tous les produits
                PetService petService = new PetService();
                List<PetTab> allPets = petService.getAllPets();

                // Filtrer les produits de la catégorie "Special offers" (categoryId = 3)
                List<PetTab> specialProducts = new ArrayList<>();
                for (PetTab pet : allPets) {
                    if (pet.getCategoryId() == 3) { // 3 est l'ID de la catégorie "Special offers"
                        specialProducts.add(pet);
                    }
                }

                // Afficher les produits filtrés
                for (PetTab product : specialProducts) {
            %>
                <div class="feat_prod_box">
                    <div class="prod_img">
                        <a href="details.jsp?petId=<%= product.getId() %>">
                            <img src="<%= product.getImageUrl() %>" alt="<%= product.getName() %>" title="<%= product.getName() %>" border="0" />
                        </a>
                    </div>
                    <div class="prod_det_box">
                        ...
                        <div class="box_center">
                            ...
                            <a href="details.jsp?petId=<%= product.getId() %>" class="more">- more details -</a>
                            <div class="clear"></div>
                        </div>
